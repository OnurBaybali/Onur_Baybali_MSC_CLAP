...
BUG: Returns base_idx instead of audio_idx, causing incorrect positive pair matching
"""
...
class HybridDataset(Dataset):
    ...
    NOTE: This version has a bug - returns base_idx instead of audio_idx
    """
    ...
    def __getitem__(self, idx):
        ...
        # BUG: Returns base_idx instead of audio_idx
        return audio, text, base_idx, perceptual_feat
...
def hybrid_collate_fn(batch):
    ...
    return audio, text, pvec, idx  # Note: idx is base_idx (caption index), not audio_idx
